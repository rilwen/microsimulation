...
TEST(Adapt1D, Adaptive15)
{
	const double tolerance = 1E-14;
	Adapt1D_15 integrator(20, tolerance, false);
...
//TEST(Adapt1D, Adaptive21)
//{
//	const double tolerance = 1E-14;
//	Adapt1D_21 integrator(20, tolerance, false);
//
//	double result = integrator.integrate(fun2, -1, 1);
//	EXPECT_NEAR(0, result, tolerance);
//
...
TEST(Adapt1D, Adaptive41)
{
	const double tolerance = 1E-14;
	Adapt1D_41 integrator(20, tolerance, false);
