...
namespace averisera {
	namespace microsim {
        /** Observes emigrant population */
        class ObserverDemographicsEmigrants: public ObserverDemographics {
        public:
            /**
			...
			*/
            ObserverDemographicsEmigrants(std::shared_ptr<ObserverResultSaver> result_saver, const age_ranges_type& age_ranges, size_t nbr_dates, const std::string& own_filename_stub = std::string())
                : ObserverDemographics(result_saver, "emigrants", age_ranges, nbr_dates, own_filename_stub) {}
